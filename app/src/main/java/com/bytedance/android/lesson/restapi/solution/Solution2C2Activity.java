...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    private List<FeedResponse.FeedsBean> mFeeds = new ArrayList<>();
    private static final String mStudentId = "1120162025";
    private static final String mUserName = "wangyi";
    ...
    private void postVideo() {
        ...
        Call<PostVideoResponse> postVideoResponse = NetworkUtils.PostVideoresponse(mStudentId, mUserName,image, video);
        Log.d(TAG, "postVideo: " + postVideoResponse);

        mcalllist.add(postVideoResponse);



        postVideoResponse.enqueue(new Callback<PostVideoResponse>() {
            ...
            public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    Toast.makeText(Solution2C2Activity.this, "Post succeed", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(Solution2C2Activity.this, "Post failed", Toast.LENGTH_LONG).show();
    ...
    public void fetchFeed(View view) {
        ...
        Call<FeedResponse> feedResponseCall = NetworkUtils.Feedresponse();
